...
* **⚡ FLASH AT YOUR OWN RISK:** This module modifies low-level system settings and memory management. While it is fully tested and safe, we are not responsible for any bootloops, hardware strain, or unexpected behavior on your device.
